                    ...
                    <form id="formdata" class="general-setting" action="<?php echo e(url('email-settings')); ?>" method="POST" novalidate="novalidate">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-md-4 col-sm-12">
                                ...
                                <input name="mail_host" value="<?php echo e(env('MAIL_HOST')); ?>" type="text" required placeholder="<?php echo e(__('mail_host')); ?>" class="form-control" />
                            </div>
                            <div class="form-group col-md-4 col-sm-12">
                                <label><?php echo e(__('mail_port')); ?></label>
                                <input name="mail_port" value="<?php echo e(env('MAIL_PORT')); ?>" type="text" required placeholder="<?php echo e(__('mail_port')); ?>" class="form-control" />
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-4 col-sm-12">
                                <label><?php echo e(__('mail_username')); ?></label>
                                <input name="mail_username" value="<?php echo e(env('MAIL_USERNAME')); ?>" type="text" required placeholder="<?php echo e(__('mail_username')); ?>" class="form-control" />
                            </div>
                            <div class="form-group col-md-4 col-sm-12">
                            ...
                            <div class="form-group col-md-4 col-sm-12">
                                ...
                                <input name="mail_encryption" value="<?php echo e(env('MAIL_ENCRYPTION')); ?>" type="text" required placeholder="<?php echo e(__('mail_encryption')); ?>" class="form-control" />
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-md-4 col-sm-12">
                                <label><?php echo e(__('mail_send_from')); ?></label>
                                <input name="mail_send_from" value="<?php echo e(env('MAIL_FROM_ADDRESS')); ?>" type="text" required placeholder="<?php echo e(__('mail_send_from')); ?>" class="form-control" />
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/internexaschool_clone/resources/views/settings/email_configuration.blade.php ENDPATH**/ ?>