                            ...
                            <div class="row">
                                <div class="form-group col-md-4 col-sm-12">
                                    ...
                                    <div class="input-group col-xs-12">
                                        ...
                                        <div class="col-md-12">
                                            <img height="50px" src='{{ isset($settings['favicon']) ?asset('public/storage/'.$settings['favicon']) : '' }}'>
                                ...
                                <div class="form-group col-md-4 col-sm-12">
                                    ...
                                    <div class="input-group col-xs-12">
                                        ...
                                        <div class="col-md-12">
                                            <img height="100%" src='{{ isset($settings['logo1']) ? asset('public/storage/'.$settings['logo1']) : '' }}'>
                                ...
                                <div class="form-group col-md-4 col-sm-12">
                                    ...
                                    <div class="input-group col-xs-12">
                                        ...
                                        <div class="col-md-12">
                                            <img height="50px" src='{{ isset($settings['logo2']) ?  asset('public/storage/'.$settings['logo2']) : '' }}'>
                                        </div>
                                    </div>
                                </div>
                            </div>
