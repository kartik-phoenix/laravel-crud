...
<link rel="stylesheet" href="{{ asset('public/assets/select2/select2.min.css') }}">
<link rel="stylesheet" href="{{ asset('public/assets/jquery-toast-plugin/jquery.toast.min.css') }}">
<link rel="stylesheet" href="{{ asset('public/assets/color-picker/color.min.css') }}">
@if ($lang)
    @if ($lang->is_rtl)
...
<link rel="shortcut icon" href="{{ asset('public/storage/'. env('FAVICON')) }}"/>
